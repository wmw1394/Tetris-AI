...
public class State {
	...
	// legalMoves are a 3-dimenstional array
	// legalMove[i][j][k], i for 7 piece_types, j for orientation_types for each piece_type
	// and k describes the move: k = 0 to get orientation of this move, k = 1 to get slot of this move
	{
		//for each piece type
	...
	// until this function call, State is able to perform nextPiece 
	// because it has known the orientation and slot of the nextPiece
